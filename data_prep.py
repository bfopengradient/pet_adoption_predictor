...
class prep_pets:
	...
	def produce_predictor_matrix():
		...
		#The csv version of this file is named as pets.csv in my GitHub repo entitled pet_adoption_predictor.
        ...
        #Set file path as desired for saved csv file
		df_embeddings.to_csv('...my_features.csv')
        ...
        #Write copy of the feature set converted to a list to sql table called df_embeddings.
		df_embeddings['list'].to_sql(name='df_embeddings',con=con,if_exists='replace')
		 

		#Return the feature set as a list which will be assigned as the X variable for the algorithm. Also return the target variable which is asigned to the y variable for the algorithm.
